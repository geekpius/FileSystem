    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(default='super', max_length=20)),
        ...
        migrations.AddIndex(
            model_name='user',
            index=models.Index(fields=['zone'], name='account_use_zone_b2fa93_idx'),
        ),
        migrations.AddIndex(
            model_name='user',
            index=models.Index(fields=['owner'], name='account_use_owner_e36011_idx'),
        ),
    ]
